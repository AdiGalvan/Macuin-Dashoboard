...
<body class="antialiased font-sans bg-gray-200">
   ...
   <!-- ----------------Botones de agregar y tickets cancelados--------------- -->
                ...
                <table class="min-w-full leading-normal ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <button id="modalAsignarTicket" class=" text-orange-500 hover:text-orange-400 font-bold py-1 px-1 rounded ">
                                <i class="material-icons text-3xl ">forward_to_inbox</i>   
                            </button>
                            </td>
                            <td class="px-5 py-2 border-b border-gray-200 bg-white text-lg">
                            <button id="modalComentario" class=" text-blue-900 hover:text-blue-700 font-bold py-1 px-1 rounded ">
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-2 border-b border-gray-200 bg-white text-xl ">
                                <button class=" hover:text-red-700 text-red-800 font-bold py-1 px-1 rounded">
                                    <i class="material-icons text-3xl">picture_as_pdf</i> 
    ...
    <!-- <script>
        function generarPDF() {
            // Redirige a la página que generará el PDF
            window.location.href = 'generar_pdf.blade.php';
        }
</script> -->


    @include('partials.modal_generarTicket')
    
    @include('partials.modal_asignarTicket')

    @include('partials.modal_agregarComentario')
